...
export default function UploadGate({
    uploading, dragOver, uploadError, onDrop, onDragOver, onDragLeave, onClick,
    youtubeUrl, setYoutubeUrl, onYoutubeSubmit, youtubeLoading, youtubeError,
    websiteUrl, setWebsiteUrl, onWebsiteSubmit, websiteLoading, websiteError, websiteProgress,
}) {
    const [mode, setMode] = useState(null); // null | "pdf" | "youtube" | "website"
                            ...
                            <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
                                ...
                                <ul className="space-y-1">
                                    {[
                                        ...
                                        <li key={item} className="text-zinc-500 text-xs flex items-start gap-1.5">
